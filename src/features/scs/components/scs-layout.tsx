...
const NAV_ITEMS = [
  { id: "overview", label: "Overview", icon: Users, href: "/dashboard/scs/overview" },
  { id: "dashboard", label: "Dashboard", icon: TrendingUp, href: "/dashboard/scs/dashboard" },
  { id: "people", label: "People", icon: User, href: "/dashboard/scs/people" },
  { id: "plans", label: "Plans", icon: ClipboardList, href: "/dashboard/scs/plans" },
  { id: "coverage", label: "Coverage", icon: FileText, href: "/dashboard/scs/coverage" },
  { id: "messages", label: "Messages", icon: MessageSquare, href: "/dashboard/scs/messages" },
];

export function ScsLayout({ children }: { children: React.ReactNode }) {
        ...
        <div>
          ...
          <nav className="space-y-1 px-3">
            {NAV_ITEMS.map((item) => {
              ...
              const isActive = pathname.startsWith(item.href) || (pathname === "/dashboard/scs" && item.id === "overview");
              return (
                <Link
                  key={item.id}
                  href={item.href}
